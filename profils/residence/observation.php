...
if ($_SERVER['REQUEST_METHOD'] == 'POST' &&
    ...
    $idObservation = isset($_POST['idObservation']) && is_numeric($_POST['idObservation']) 
    ? (int)$_POST['idObservation'] 
    : null;
...
<body>
    ...
    <div class="observation-container">
        ...
        <form method="POST" action="observation" class="needs-validation" novalidate>
            <div class="mb-4">
            ...
            <input type="hidden" name="idObservation"
                value="<?= htmlspecialchars($idObservation, ENT_QUOTES, 'UTF-8') ?>">
