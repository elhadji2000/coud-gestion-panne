...
$result = allPannesByUser($connexion, $userId, 1, 200); // Récupère toutes les pannes
...
<body>
    ...
    <div class="container">
        ...
        <div class="row mb-4">
            ...
            <div class="col-3 text-end justify-content-end search-container">
                <a href="ajoutPanne.php" class="btn btn-success form-control">
