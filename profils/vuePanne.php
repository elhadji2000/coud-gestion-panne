...
$panneInfo = $pannes[0]; // Informations générales

$interventions = [];
foreach ($pannes as $row) {
    if (!empty($row['intervention_id'])) {
        $interventionId = $row['intervention_id'];
        if (!isset($interventions[$interventionId])) {
        ...
        if (!empty($row['observation_id'])) {
            $interventions[$interventionId]['observations'][] = [
                'id' => $row['observation_id'],
                'id_int' => $row['intervention_id'],
                'date' => $row['date_observation'],
                'evaluation' => $row['evaluation_qualite'],
                'commentaire' => $row['commentaire_suggestion']
            ];
        }
    }
}
...
<body>
    ...
    <div class="container py-4">
        <div class="row mb-4">
            <div class="col-12 text-center">
                <h2 class="fw-bold"><i class="fas fa-tools me-2"></i>Détails de la Panne
                    #<?= htmlspecialchars($idPanne) ?></h2>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="card mb-3 shadow-sm">
                    ...
                    <div class="card-body">
                            ...
                            <table class="table table-bordered table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($obs['evaluation']) ?></td>
                        ...
                        <?php else: ?>
                        <p class="text-muted"><em>Aucune observation pour cette intervention.</em></p>
                        <?php endif; ?>
                    </div>
                </div>
                <?php endforeach; ?>
    ...
    <div class="modal fade" id="chefAtelierModal" tabindex="-1" aria-labelledby="chefAtelierModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-warning text-white">
    ...
    <div class="modal fade" id="chefAtelierDeleteModal" tabindex="-1" aria-labelledby="chefAtelierDeleteModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
