...
<head>
    ...
    <title>GESCOUD - Liste des Pannes</title>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($isSEM): ?>
                                ...
                                <?php else: ?>
                                    <a href="imputation.php?idPanne=<?= htmlspecialchars($panne['id']) ?>"
                        ...
                        <td>
                            ...
                            <?php else: ?>
                                <a href="intervention?idp=<?= $panne['id'] ?>"
                                    class="btn btn-danger btn-sm action-btn" title="Intervenir">
