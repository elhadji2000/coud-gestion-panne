...
$reference = $_GET['ref'] ?? '';
$sorties = getSortiesParReference($connexion, $reference);
?>
    ...
    <div class="page-header">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div>
                    <a href="sortie_stock.php" class="btn btn-secondary mb-3">← Retour</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="suppr_sortie.php?id=<?= $sortie['id'] ?>" class="btn btn-sm btn-danger"
